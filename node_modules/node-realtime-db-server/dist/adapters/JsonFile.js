...
var JsonFile = function (_Adapter) {
  _inherits(JsonFile, _Adapter);
  ...
  function JsonFile() {
    ...
    var _this = _possibleConstructorReturn(this, (JsonFile.__proto__ || Object.getPrototypeOf(JsonFile)).call(this, dbOptions));

    var _dbOptions$initalData = dbOptions.initalData,
        initalData = _dbOptions$initalData === undefined ? {} : _dbOptions$initalData,
        _dbOptions$filePath = dbOptions.filePath,
        filePath = _dbOptions$filePath === undefined ? (0, _path.join)(process.cwd(), 'node-realtime-db.json') : _dbOptions$filePath;

    _this.jsonFilePath = filePath;

    var exist = _fsExtra2.default.existsSync(filePath);
    if (!exist) {
      _fsExtra2.default.writeJsonSync(_this.jsonFilePath, initalData);
    }
    return _this;
  }
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _fsExtra2.default.readJson(this.jsonFilePath);

              case 2:
                data = _context.sent;
                return _context.abrupt('return', _objectPath2.default.get(data, path, undefined));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                _objectPath2.default.set(data, path, newValue);
                _context2.next = 6;
                return _fsExtra2.default.writeJson(this.jsonFilePath, data);
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 2:
                ...
                _objectPath2.default.set(data, path, arr);
                _context7.next = 8;
                return _fsExtra2.default.writeJson(this.jsonFilePath, data);
